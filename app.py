...
def main():
    ...
    st.markdown("""
     :dart:  This app is made using Streamlit(Open-source python framework). This app is made to predict customer churn for telecom companys' use case. This app is functional for online and batch of data. \n
    """)
    ...
    if add_selectbox == "Online":
        ...
        monthlycharges = st.number_input('The amount charged to the customer monthly', min_value=0, max_value=500, value=0)
        ...
        if monthlycharges > industry_avg:
            st.warning('The tariff plan is higher compared to other telecom providers. Customers may churn if no measures are taken.')
        elif monthlycharges < industry_avg:
            st.success('The tariff plan is fairly less compared to other telecom providers. Customers may stay longer.')
